...
class Note extends FlxSprite
{
	...
	public function new(isFire:Bool, _strumTime:Float, _noteData:Int, ?_prevNote:Note, ?sustainNote:Bool = false)
	{
		super();
		...
		switch (daStage)
		{
			...
			default:
				...
				if(burning){
					if (daStage == 'joelDark')
					{
						frames = Paths.getSparrowAtlas('ALL_deathnotes', "bonusWeek");
					...
					{
						frames = Paths.getSparrowAtlas('NOTE_fire', "bonusWeek");
	...
	override function update(elapsed:Float)
	{
		...
		if (mustPress)
		{
			...
			{
				if (PlayState.curStage == 'joelDark') // these though, REALLY hard to hit.
				{
